...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appCHN_Chess)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appCHN_Chess))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appCHN_Chess)() {
    return 1;
}
